  ...
  if (footer) {
    ...
    band.innerHTML =
      ...
      '<svg class="digger" viewBox="0 0 220 130" xmlns="http://www.w3.org/2000/svg">' +
        '<g class="dig-boom">' +
          '<path d="M88 74 L150 40" fill="none" stroke="#E3A63C" stroke-width="13" stroke-linecap="round"/>' +
          '<path d="M150 40 L176 90" fill="none" stroke="#C17C3C" stroke-width="11" stroke-linecap="round"/>' +
          '<path d="M168 84 q-5 18 13 20 q11 1 13 -9 l-7 -2 q-2 7 -9 5 q-7 -2 -4 -12 z" fill="#140F0A"/>' +
        "</g>" +
        '<ellipse class="dust" cx="168" cy="104" rx="15" ry="7" fill="#B3A48C"/>' +
        '<rect x="14" y="100" width="156" height="22" rx="11" fill="#140F0A"/>' +
        '<circle cx="34" cy="111" r="7" fill="#8A7458"/>' +
        '<circle cx="66" cy="111" r="7" fill="#8A7458"/>' +
        '<circle cx="98" cy="111" r="7" fill="#8A7458"/>' +
        '<circle cx="130" cy="111" r="7" fill="#8A7458"/>' +
        '<circle cx="156" cy="111" r="7" fill="#8A7458"/>' +
        '<rect x="30" y="72" width="18" height="30" rx="5" fill="#140F0A"/>' +
        '<rect x="40" y="66" width="96" height="38" rx="7" fill="#2C2014"/>' +
        '<rect x="48" y="42" width="48" height="28" rx="6" fill="#8A7458"/>' +
        '<rect x="53" y="48" width="22" height="15" rx="2" fill="#F4F1EA"/>' +
      "</svg>";
